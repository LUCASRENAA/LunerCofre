...
class CredencialSitesViewSet(viewsets.ModelViewSet):
    ...
    def perform_update(self, serializer):
        ...
        # Certifique-se de que está atualizando todos os campos necessários
        serializer.save(
            titulo=titulo,
            nome=e_data_nome,
            e_cipher_nome=e_cipher_nome.nonce,
            senha=e_data_senha,
            e_cipher_senha=e_cipher_senha.nonce,
            notas=e_data_notas,
            e_cipher_notas=e_cipher_notas.nonce,
